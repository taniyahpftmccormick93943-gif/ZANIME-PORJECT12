...
const MoviesPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (genreParam) {
      // Find matching genre from our list
      ...
      <main className="pt-32 pb-20">
          ...
          >
            <div>
              <div className="flex items-center gap-3 text-red-500 mb-4">
                <Film size={24} />
                <span className="text-xs font-black uppercase tracking-[0.2em]">بەرنامەی فیلمەکان</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-black tracking-tight">فیلمەکان</h1>
            </div>
        ...
        {loading ? (
          ...
          <div className="py-40 text-center">
            ...
            <h3 className="text-xl font-black mb-2">هیچ فیلمێک نەدۆزرایەوە</h3>
